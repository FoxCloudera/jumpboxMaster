...
echo "          ---------------------------------------------------------------------------------------------------------------------------------------------"
echo "          ---------------------------------------------------------------------------------------------------------------------------------------------"
echo "          |       ssh -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -i ${BIND_MNT_TARGET}/${BIND_FILENAME} ${SSH_USERNAME}@${GET_PUBLIC_IP}          "
echo "          ---------------------------------------------------------------------------------------------------------------------------------------------"
echo "          ---------------------------------------------------------------------------------------------------------------------------------------------"
echo
echo
...
echo "          ---------------------------------------------------------------------------------------------------------------------------------------------"
echo "          ---------------------------------------------------------------------------------------------------------------------------------------------"
echo "          |       ssh -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -i ${BIND_MNT_TARGET}/${BIND_FILENAME} -CND 8157 ${SSH_USERNAME}@${GET_PUBLIC_IP}          "
echo "          ---------------------------------------------------------------------------------------------------------------------------------------------"
echo "          ---------------------------------------------------------------------------------------------------------------------------------------------"
